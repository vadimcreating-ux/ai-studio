...
2. ДВИЖЕНИЕ СУБЪЕКТА — что и как движется внутри кадра, динамика действия
3. ДВИЖЕНИЕ КАМЕРЫ — тип съёмки (дрон-шот, слежение, статика, зум, панорама)
4. ОСВЕЩЕНИЕ И АТМОСФЕРА — световые условия, настроение, цветовая гамма
5. СТИЛЬ — кинематографический стиль, жанр, референс (документальный, художественный, реклама)
6. ТЕМП И ДЛИТЕЛЬНОСТЬ — медленное/быстрое движение, ритм монтажа
7. КАЧЕСТВО — технические модификаторы (4K, кинескоп, HDR, cinematic LUT)
