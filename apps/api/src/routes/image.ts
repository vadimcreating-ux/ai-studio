...
4. СТИЛЬ — художественный стиль, референсные художники или эпоха
5. ОСВЕЩЕНИЕ — тип и характер света (золотой час, студийный свет, неон и т.п.)
6. КАМЕРА — ракурс, план, объектив, глубина резкости
7. КАЧЕСТВО — технические модификаторы (фотореализм, 8K, award-winning photography и т.п.)
